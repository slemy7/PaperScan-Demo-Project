...
class PaperScanPaginatedPaginatedAdapter(
    private val onSelectedItemCountChanged: (Int) -> (Unit)
) : PagingDataAdapter<PaperScanPaginatedPaginatedAdapter.PaperScanItemWrapper, PaperScanPaginatedPaginatedAdapter.PaperScanViewHolder>(
    REPO_COMPARATOR
) {

    companion object {
        private val REPO_COMPARATOR = object : DiffUtil.ItemCallback<PaperScanItemWrapper>() {
            override fun areItemsTheSame(
                oldItem: PaperScanItemWrapper,
                newItem: PaperScanItemWrapper
            ): Boolean =
                oldItem == newItem
